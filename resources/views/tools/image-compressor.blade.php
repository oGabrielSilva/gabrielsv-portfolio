...
<div class="space-y-6">
    ...
    {{-- Upload area --}}
    <div id="upload-area" class="bg-neutral-800/50 border-2 border-dashed border-neutral-700/50 rounded-xl p-8 transition-colors">
            ...
            <div>
                ...
                <div class="hs-dropdown relative [--strategy:absolute] [--adaptive:none]">
                    <button id="width-dropdown" type="button"
                        ...
                        <svg class="hs-dropdown-open:rotate-180 size-4 transition-transform" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            <path d="m6 9 6 6 6-6"/>
                        </svg>
                    </button>
