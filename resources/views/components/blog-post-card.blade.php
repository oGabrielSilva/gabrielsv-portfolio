...
<article
    ...
    data-aos="fade-up">
    <a href="{{ $link }}" target="_blank" rel="noopener noreferrer" class="block overflow-hidden h-40">
    ...
    <div class="p-5 flex-1 flex flex-col">
        ...
        <h3 class="text-lg font-bold text-white mb-2 leading-tight">
            <a href="{{ $link }}" target="_blank" rel="noopener noreferrer" class="hover:text-bulma-primary transition-colors">
                {{ $title }}
            </a>
        </h3>
