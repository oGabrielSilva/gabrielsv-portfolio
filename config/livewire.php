...
return [
    ...
    */
    ...
    'payload' => [
        ...
        'max_nesting_depth' => 30,   // Subido de 10: o RichEditor (TipTap) do Filament guarda o conteudo como JSON aninhado, e tabelas/listas (doc > table > tableRow > tableCell > paragraph > text) passam de 10 niveis ao editar uma celula.
